...
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] md:gap-[50px] lg:gap-[70px] mt-[30px] md:mt-[50px] ">
//         {/* Dog Breeds */}
//         <div 
...
//           ${hovered !== null && hovered !== 0 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 0 ? 'scale-[1]' : ''}`}
//           onMouseEnter={() => setHovered(0)}
//           onMouseLeave={() => setHovered(null)}
//         >
//           <img src={dogsgrp} alt="Dog Breeds" className="w-full h-[120px] md:h-[250px] lg:h-[300px] object-cover rounded-[20px] md:rounded-[30px] lg:rounded-[40px]" />
...
//           ${hovered !== null && hovered !== 1 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 1 ? 'scale-[1]' : ''}`}
...
//         <div 
//           className={`category-card bg-yellow-300 p-4 rounded-[20px] md:rounded-[30px] lg:rounded-[40px] text-center transition-transform duration-300 ease-out
//           ${hovered !== null && hovered !== 2 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 2 ? 'scale-[1]' : ''}`}
...
//         <div 
//           className={`category-card bg-yellow-300 p-4 rounded-[20px] md:rounded-[30px] lg:rounded-[40px] text-center transition-transform duration-300 ease-out
//           ${hovered !== null && hovered !== 4 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 4 ? 'scale-[1]' : ''}`}
...
//         <div 
//           className={`category-card bg-blue-500 p-4 rounded-[20px] md:rounded-[30px] lg:rounded-[40px] text-center transition-transform duration-300 ease-out
//           ${hovered !== null && hovered !== 3 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 3 ? 'scale-[1]' : ''}`}
...
//         <div 
//           className={`category-card bg-yellow-300 p-4 rounded-[20px] md:rounded-[30px] lg:rounded-[40px] text-center transition-transform duration-300 ease-out
//           ${hovered !== null && hovered !== 5 ? 'blur-sm scale-[0.8] opacity-90' : ''} 
//           ${hovered === 5 ? 'scale-[1]' : ''}`}
